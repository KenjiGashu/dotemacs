...
(use-package company
  ...
  (setq company-backends '((company-capf company-files company-keywords company-dabbrev-code company-yasnippet company-dabbrev))
	)
...
(use-package lsp-dart
  :ensure t
  :init
  (setq lsp-dart-flutter-sdk-dir (concat (replace-regexp-in-string "\\\\" "/" (getenv "FLUTTER_HOME"))))
